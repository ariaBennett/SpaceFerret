...
//  var rotateAmount : float = Vector3.Angle(ship.transform.forward, this.transform.forward);
//  Debug.Log(rotateAmount);
 // this.transform.rotation = Quaternion.Lerp(this.transform.rotation, ship.transform.rotation, Time.deltaTime);
  //this.transform.position = Vector3.Lerp(this.transform.position, ship.transform.position, Time.deltaTime);
